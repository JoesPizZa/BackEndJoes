...
public class DossierController {
    ...
    @RequestMapping(value="/DossierByCin/{cin}",method=RequestMethod.GET)
    public Dossier findDossierByCIn(@PathVariable int cin) {
        return dossierService.findDossierByCin(cin);
    }
