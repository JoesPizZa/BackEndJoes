...
public class ContratController {
    ...
    @RequestMapping(value="/ContratByCin/{cin}",method=RequestMethod.GET)
    public List<Contrat> findContratByCin(@PathVariable int cin) {
        return contratService.findContratByCin(cin);
    }
